...
scheduleArray = np.genfromtxt("/Users/aj/Desktop/PYTHON/projects/schedule/scheduleArrayScratch.csv", delimiter=',', dtype='str')
...
class Ui_MainWindow(object):
    ...
    def on_pushButton_clicked(self):
        ...
        readArray = np.genfromtxt("/Users/aj/Desktop/PYTHON/projects/schedule/scheduleArrayScratch.csv", delimiter=',', dtype='str')
        if readArray.size == 0:
        ...
        np.savetxt("/Users/aj/Desktop/PYTHON/projects/schedule/scheduleArrayScratch.csv", _scheduleArray, delimiter=",", fmt='%s')
        rereadArray = np.genfromtxt("/Users/aj/Desktop/PYTHON/projects/schedule/scheduleArrayScratch.csv", delimiter=',', dtype='str')
        ...
        np.savetxt("/Users/aj/Desktop/PYTHON/projects/schedule/scheduleArrayScratch.csv", rereadArray, delimiter=",", fmt='%s')
        k = 0
        for i in range(len(rereadArray)):
            for j in range(0, 4):

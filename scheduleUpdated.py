...
class Ui_MainWindow(object):
    ...
    def on_pushButton_clicked(self):
        ...
        readArray = np.genfromtxt("./scheduleArrayScratch.csv", delimiter=',', dtype='str')
        if readArray.size == 0:
        ...
        np.savetxt("./scheduleArrayScratch.csv", _scheduleArray, delimiter=",", fmt='%s')
        rereadArray = np.genfromtxt("./scheduleArrayScratch.csv", delimiter=',', dtype='str')
